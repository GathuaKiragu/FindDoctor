...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    //  FirebaseDoctorListAdapter, the ItemTouchHelperAdapter instance will pass the gesture event back to the
    ...
    //  which will eventually handle updating the doctors ArrayList to reflect the item's new position.
